...
Review.create(review: "This game is really good",rating: 8, game_id: g9.id, user_id: u4.id)
Review.create(review: "Terrible Game! Why would you play this.",rating: 2, game_id: g4.id, user_id: u9.id)
Review.create(review: "This game is my LIFE!! I can't explain the joy.",rating: 10, game_id: g10.id, user_id: u11.id)
Review.create(review: "Who the hell came up with this idea? We need to have a talk.",rating: 4, game_id: g1.id, user_id: u12.id)
Review.create(review: "It was okay. I guess",rating:5 , game_id: g3.id, user_id: u3.id)
Review.create(review: "I can't wait for the sequel to come out.",rating: 9, game_id: g6.id, user_id: u8.id)
Review.create(review: "Reminds me of the old halo multiplayer days.",rating:7 , game_id: g1.id, user_id: u12.id)
Review.create(review: "WHY? Just Why?",rating:3 , game_id: g11.id, user_id: u11.id)
Review.create(review: "No comment.",rating: 4, game_id: g8.id, user_id: u1.id)
Review.create(review: "I wasted money on this. I bet I could build better",rating: 2, game_id: g7.id, user_id: u1.id)
Review.create(review: "My dog enjoys watching me play this game!",rating: 7, game_id: g4.id, user_id: u5.id)
Review.create(review: "I think my grandma can play better than me. Fix the controls so I can be cool again.",rating: 4, game_id: g1.id, user_id: u1.id)
Review.create(review: "Really fun to play with friends!",rating: 8, game_id: g5.id, user_id: u9.id)
Review.create(review: "The developers really listen to the community!",rating: 9, game_id: g3.id, user_id: u8.id)
Review.create(review: "Too many hackers!!!!!!!!!!!!!",rating: 6, game_id: g12.id, user_id: u12.id)
Review.create(review: "By far my least favorite game!!!",rating:1 , game_id: g11.id, user_id: u4.id)
Review.create(review: "I play this game for hours on end and never get bored!",rating: 10, game_id: g6.id, user_id: u12.id)
Review.create(review: "I wish the servers didn't have so many issues",rating: 3, game_id: g8.id, user_id: u4.id)
Review.create(review: "Cant wait for next years release!!",rating: 10, game_id: g2.id, user_id: u9.id)
Review.create(review: "1/10",rating: 1, game_id: g5.id, user_id: u5.id)
